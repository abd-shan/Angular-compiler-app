...
public interface AngularParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link AngularParser#routeFile}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRouteFile(AngularParser.RouteFileContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code Spread}
	 * labeled alternative in {@link AngularParser#spreadOrExpr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSpread(AngularParser.SpreadContext ctx);
	/**
	 * Visit a parse tree produced by the {@code NoSpread}
	 * labeled alternative in {@link AngularParser#spreadOrExpr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNoSpread(AngularParser.NoSpreadContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code TerminalElement}
	 * labeled alternative in {@link AngularParser#element}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTerminalElement(AngularParser.TerminalElementContext ctx);
	/**
	 * Visit a parse tree produced by the {@code NonTerminalElement}
	 * labeled alternative in {@link AngularParser#element}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNonTerminalElement(AngularParser.NonTerminalElementContext ctx);
	/**
