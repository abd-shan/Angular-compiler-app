// Generated from D:/useful/practice/Java/angular-compiler2/antlr/AngularLexer.g4 by ANTLR 4.13.2
...
public class AngularLexer extends Lexer {
	...
	public static final int
		...
		SELECTOR=14, STYLES_URL=15, PROVIDERS=16, IMPLEMENTS=17, LBRACE=18, RBRACE=19, 
		LPARENTHESIS=20, RPARENTHESIS=21, LBRACKET=22, RBRACKET=23, COLON=24, 
		COMMA=25, STRING=26, BACKTICK=27, SEMICOLON=28, QUESTION=29, ARROW=30, 
		STATE=31, AT_INJECTABLE=32, PROVIDED_IN=33, INTERFACE=34, OBSERVABLE=35, 
		SUBJECT=36, ASYNC=37, PIPE=38, MAP=39, CREATE_ACTION=40, CREATE_REDUCER=41, 
		ON=42, EQUAL_SIGN=43, NUMBER=44, STRINGDL=45, BOOLEAN=46, ANY=47, VOID=48, 
		NULL=49, LET=50, IF=51, FOR=52, CONSTRUCTOR=53, CONST=54, RETURN=55, SWITCH=56, 
		CASE=57, DEFAULT=58, BREAK=59, EVENT=60, NEW=61, PUBLIC=62, PRIVATE=63, 
		PROTECTED=64, READONLY=65, THIS=66, DOT=67, ELLIPSIS=68, PLUS=69, MINUS=70, 
		STAR=71, SLASH=72, AND_OP=73, OR_OP=74, NOT_OP=75, EQEQ=76, EQEQEQ=77, 
		NEQ=78, NEQEQ=79, LTE=80, GTE=81, PLUS_EQUAL=82, MINUS_EQUAL=83, STAR_EQUAL=84, 
		SLASH_EQUAL=85, PERCENT=86, TILDE=87, UNDEFINED=88, VAR=89, ANGULAR_EVENT=90, 
		ANGULAR_PROPERTY=91, ANGULAR_TWO_WAY=92, ANGULAR_BINDING=93, TAG_OPEN=94, 
		TAG_CLOSE=95, TAG_OPEN_SELF=96, TAG_CLOSE_SELF=97, NG_IF=98, NG_FOR=99, 
		ATTRIBUTE=100, ANGULAR_ATTRIBUTE_PROPERTY=101, ANGULAR_ATTRIBUTE_EVENT=102, 
		ANGULAR_ATTRIBUTE_TWO_WAY=103, DISPLAY=104, MARGIN=105, FONT_FAMILY=106, 
		PADDING=107, WIDTH=108, BORDER_RIGHT=109, OVERFLOW_Y=110, BORDER=111, 
		CURSOR=112, TRANSITION=113, HEIGHT=114, MARGIN_RIGHT=115, BORDER_SOLID=116, 
		COLOR=117, BACKGROUND=118, BACKGROUND_COLOR=119, BORDER_RADIUS=120, GAP=121, 
		BORDER_BOTTOM_COLOR=122, MARGIN_BOTTOM=123, TOP=124, LEFT=125, POSITION=126, 
		JUSTIFY_CONTENT=127, ALIGN_ITEMS=128, MAX_WIDTH=129, BOX_SIZING=130, MAGIN_TOP=131, 
		OBJECT_FIT=132, Z_INDEX=133, TEXT_DECORATION=134, FONT_WEIGHT=135, RESIZE=136, 
		TSXT_ALIGN=137, FONT_SIZE=138, GRID_TEMPLATE_COLUMNS=139, BOX_SHADOW=140, 
		FLEX_DIRECTION=141, OVERFLOW=142, NUMERIC_VALUE=143, COLOR_VALUE=144, 
		CSS_SELECTOR=145, ID=146, WS=147, COMMENT=148, SPACE=149;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"AT_COMPONENT", "STANDALONE", "IMPORTS", "IMPORT", "STYLES", "TEMPLATE", 
			"TEMPLATE_URL", "TRUE", "FALSE", "FROM", "AS", "CLASS", "EXPORT", "SELECTOR", 
			"STYLES_URL", "PROVIDERS", "IMPLEMENTS", "LBRACE", "RBRACE", "LPARENTHESIS", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'{'", "'}'", "'('", "')'", "'['", "']'", "':'", "','", null, "'`'", 
			"';'", "'?'", "'=>'", "'state'", "'@Injectable'", "'providedIn'", "'interface'", 
			"'Observable'", "'Subject'", "'async'", "'|'", "'map'", "'createAction'", 
			"'createReducer'", "'on'", "'='", "'number'", "'string'", "'boolean'", 
			"'any'", "'void'", "'null'", "'let'", "'if'", "'for'", "'constructor'", 
